...
//			getLeftPanel().setSession(false);
	...
	public void actionPerformed(ActionEvent e) 
	{
		 ...
		 if (p.getActionCommand().equals("Restore default parameters")) 
		 {
			 ...
			 boolean rc = parameterSettings.getUpperPanel().getNetx().readParam("defaultParameters");
		 ...
		 {
			 otherSettings.getUpperPanel().loadSettings(MyConstants.DEFAULT_OTHER_SETTINGS);
