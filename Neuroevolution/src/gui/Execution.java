...
}public void executeForClass(JTextArea _textArea) 
{
	...
	try 
	{
		...
		Class_inp = bin_inp.class; //Class.forName(EnvConstant.DATA_INP);
		...
		Class_tgt = xor_out.class; //Class.forName(EnvConstant.DATA_OUT);
	    ...
	    Class_fit = xor_fit.class; //Class.forName(EnvConstant.CLASS_FITNESS);
